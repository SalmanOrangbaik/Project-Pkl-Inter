    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 text-center text-lg-start">
          ...
          <a href="" class="btn btn-outline-primary px-4 py-2 rounded-pill">Booking Sekarang</a>
        </div>
        <div class="col-lg-6 text-center">
          <img src="" alt="Ilustrasi Ruangan" class="img-fluid rounded shadow-sm" style="max-height: 300px;">
        </div>
      </div>
    </div>
  </section>
