            ...
            <div class="col-md-8 grid-margin stretch-card w-100">
                <div class="card">
                    <div class="card-body performane-indicator-card">
                        <div class="d-sm-flex">
                            <h4 class="card-title flex-shrink-1">Tambah Jadwal</h4>
                        </div>
                        <div class="container">
                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('backend.jadwal.store') }}" method="POST">
                                                ...
                                                <div class="form-group mb-3 mt-3">
                                                    ...
                                                    <textarea name="keterangan" maxlength="500" class="form-control @error('keterangan') is-invalid @enderror" rows="3">{{ old('keterangan') }}</textarea>
                                                    @error('keterangan')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
